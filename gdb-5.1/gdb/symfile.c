/* gdb-5.1/gdb/symfile.c - core analysis suite
 *
 ...
 *
 * CVS: $Revision: 1.2 $ $Date: 2001/12/04 19:02:02 $
 */
...
#ifdef MCLX
    {
      void patch_load_module(struct objfile *, struct minimal_symbol *);
      patch_load_module(objfile, NULL);
    }
#endif
